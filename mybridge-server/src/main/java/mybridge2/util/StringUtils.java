...
public class StringUtils {
	...
	public static List splitDBdotName(String src, String cat, String quotId,
		...
		if (trueDotIndex != -1) {
			...
			if (isQuoted) {
				tmpCat = new String(StringUtils.stripEnclosure(retval
				...
				retval = new String(StringUtils.stripEnclosure(
			...
			retval = new String(StringUtils.stripEnclosure(retval.getBytes(),
					quotId, quotId));
		}
